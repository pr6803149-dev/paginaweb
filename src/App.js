...
const App = () => {  
  ...
  const [images, setImages] = useState([
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQO0xzblNE28JRZMLmPi6CvWYX0sQ0EBemOrw&s", "https://concepto.de/wp-content/uploads/2014/08/CPU-e1551228076500.jpg", "https://arceodanielaj.wordpress.com/wp-content/uploads/2015/11/partes-de-pc.jpg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4IuIoUQlymZjMyTqCyDk5I4_jDZ-_bO8ztw&s"
  ]);
      ...
      <div className="max-w-6xl mx-auto px-4">  
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">  
          {images.map((img, index) => (  
            <div  
              key={index}  
              className="bg-amber-800 rounded-lg p-6 shadow-md min-h-[400px] flex flex-col items-center justify-center text-center text-white"
            >  
